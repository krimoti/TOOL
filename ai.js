...
` +
  ...
  function respond(rawInput, currentUser, db) {
    ...
    else if (intent === 'who_vacation')  r = respondWhoAt(db, todayDi, currentUser, 'vacation');
    else if (intent === 'who_wfh')       r = respondWhoAt(db, todayDi, currentUser, 'wfh');
    else if (intent === 'who_sick')      r = respondWhoAt(db, todayDi, currentUser, 'sick');
    else if (intent === 'who_office')    r = respondWhoAt(db, todayDi, currentUser, 'office');
    ...
    else if (intent === 'departments')   r = resolveDirective('DEPARTMENTS', currentUser, db);
    else if (intent === 'employees')     r = resolveDirective('EMPLOYEES', currentUser, db);
    else if (intent === 'upcoming_vacations') r = resolveDirective('VACATIONS', currentUser, db);
